...
THAT PRINTS THE CONCATENATED PASSWORD SAVED BEFORE
*/

// create a single variable that contains every prompt variable
const password= name + surname + favColor + 21

//print that variable
document.getElementById ('secure').innerHTML=`La password assegnata è: ${password}`